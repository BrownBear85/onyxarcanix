...
@OnlyIn(Dist.CLIENT)
public class MagicParticle extends DustParticleBase<DustParticleOptions> {
    protected MagicParticle(ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed, DustParticleOptions pOptions, SpriteSet pSprites) {
    ...
    public static class Provider implements ParticleProvider<DustParticleOptions> {
        ...
        public Particle createParticle(DustParticleOptions pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            return new MagicParticle(pLevel, pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed, pType, this.sprites);
        }
    }
}
